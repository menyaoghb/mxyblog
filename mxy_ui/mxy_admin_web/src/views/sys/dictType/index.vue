        ...
        <el-card class="box-card">
          <div class="dic-type-div">
            ...
            <div class="filter-container">
              <el-row :gutter="20">
                <el-col :span="8">
                  <el-input placeholder="请输入字典名称" v-model="typeListQuery.dictName" clearable @keyup.enter.native="typeFilter">
                    <template slot="prepend">姓名</template>
                  </el-input>
                </el-col>
                <el-col :span="8">
                  <div class="grid-content bg-purple">
                    <el-input placeholder="请输入字典类型" v-model="typeListQuery.dictType" clearable @keyup.enter.native="typeFilter">
            ...
            <!--分页-->
            <pagination v-show="typeTotal>0" :total="typeTotal" :page.sync="typeListQuery.currentPage" :limit.sync="typeListQuery.pageSize"
        ...
        <el-card class="box-card">
          <div class="dic-type-div">
            ...
            <div class="filter-container">
              <el-row :gutter="20">
                <el-col :span="8">
                  <el-input placeholder="请输入名称" v-model="dataListQuery.dictName" clearable @keyup.enter.native="dataFilter">
                    <template slot="prepend">姓名</template>
                  </el-input>
                </el-col>
                <el-col :span="8">
                  <div class="grid-content bg-purple">
                    <el-input placeholder="请输入值" v-model="dataListQuery.dictValue" clearable @keyup.enter.native="dataFilter">
                      <template slot="prepend">账号</template>
                    </el-input>
                  </div>
                </el-col>
            ...
            <el-table
              ...
              <el-table-column prop="parentId" label="排序" align="center"></el-table-column>
              <el-table-column label="状态" width="90" class-name="status-col">
                <template slot-scope="{row}">
                  <el-tooltip v-for="item in statusOptions" v-if="row.status===item.key" :content="item.name" placement="right">
                    <el-switch
            ...
            <!--分页-->
            <pagination v-show="typeTotal>0" :total="dataTotal" :page.sync="dataListQuery.currentPage" :limit.sync="dataListQuery.pageSize"
