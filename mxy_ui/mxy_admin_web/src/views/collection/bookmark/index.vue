    ...
    <el-dialog title="详情" :visible.sync="dialogFormVisibleView" width="700px" append-to-body>
      <el-form ref="dataForm" :model="temp" label-width="120px" size="mini">
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="书签链接：">{{ temp.url }}</el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="书签名称：">{{ temp.name }}</el-form-item>
          </el-col>
          <el-col :span="12">
...
import {getList, add, edit, deleteData} from '@/api/collection/bookmark/bookmark'
import Pagination from '@/components/Pagination' // 分页

export default {
  name: 'SysBookmarksTable',
