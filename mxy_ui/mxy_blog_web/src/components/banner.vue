<template>
    <div id="banner" :class="{'home-banner':isHome}" style="margin-top: 84px;height: 100vh;">
        <div class="banner-img" :style="{'background-image': `url(${src})`}">
            <template v-if="isHome">
                <!--博主信息-->
                <div class="focusinfo" style="top: 25%" data-wow-duration="2s">
                    <!-- 头像 -->
<!--                    <div class="header-tou">
                    ...
                    <div style="text-align: center; color: #FFF;" >
                        <!--<h1>萌小妖-Blog</h1>-->
                        <p style="letter-spacing: 10px;margin: 20px 0;">{{websiteInfo.slogan}}</p>
                    </div>
                    <!-- 社交信息 -->
...
<script>
    export default {
        ...
        props:{
            src:{
                type: String,
                default: 'http://mxy.mxyit.com/e0c5198c-f13b-4d21-8315-b215a01710ee'
            },
            isHome:{
                type: [Boolean,String],
                default: false
